...
namespace DotNet.DependencyInjectionBenchmarks.Containers
{
    public class UnityContainer : IContainer
    {
        ...
        public string DisplayName => "Unity Container";

        public string Version => "Latest";

        public string WebSite => "Latest";

        public void BuildContainer()
        {
            _serviceProvider = Unity.Microsoft.DependencyInjection.ServiceProviderExtensions.BuildServiceProvider(_serviceCollection);
        }
